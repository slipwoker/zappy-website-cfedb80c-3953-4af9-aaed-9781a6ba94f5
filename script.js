    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Inkwell & Co. uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'cfedb80c-3953-4af9-aaed-9781a6ba94f5',
                    name: data.name || '',
                    email: data.email || '',
